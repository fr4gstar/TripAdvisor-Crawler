    ...
    function extractInfos($url){
        ...
        foreach($links as $element){
            ...
            foreach($as as $a){
                ...
                if($a->getAttribute('class') == 'HEADING'){
                    $name = $a->nodeValue;
                };
            };
        };
...
/*
            if($element -> getAttribute('class') == 'userRating'){
                ...
                //$amountOfReviews = $div->childNodes[0]->childNodes[0]->childNodes[0];
                //echo ($amountOfReviews -> nodeValue);
            };
    ...
    /*
        foreach($links as $element){
            ...
            if($element->getAttribute('class') == '  reviewSelector '){
                ...
                foreach($spans as $span){
                    if($span->getAttribute('class') == 'taLnk hvrIE6'){
                        taLnk hvrIE6
                    }
                }
